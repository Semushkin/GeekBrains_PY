...
class Cell:
    ...
    def __add__(self, other):
        return f'__add__:  {Cell(self.count + other.count)}'

    def __sub__(self, other):
        if self.count < other.count:
            return f'__sub__:  Error! Not enough first cell'
        return f'__sub__:  {Cell(self.count - other.count)}'

    def __mul__(self, other):
        return f'__mul__:  {Cell(self.count * other.count)}'

    def __floordiv__(self, other):
        return f'__floordiv__:  {Cell(self.count / other.count)}'

    def make_order(self, row_len):
        i = 'make_order:\n' + ('*'*row_len + '\n') * (self.count // row_len)
        i = i + '*' * (self.count % row_len)
        return i
